describe ImportFileJob, type: :job do
  let(:add_filename) { file_fixture('good_imports/add_sit_record.DAT').to_path }
  let(:update_filename) { file_fixture('good_imports/update_sit_record.DAT').to_path }
  let(:delete_filename) { file_fixture('good_imports/delete_sit_record.DAT').to_path }
  ...
  it 'creates a new SitRecord' do
    ...
    # Expect values in the database to match input from add_sit_record.DAT.
  ...
  context 'with an existing SitRecord' do
    ...
    it 'updates it' do
      ...
      # Expect values in the database to match input from update_sit_record.DAT.
