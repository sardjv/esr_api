describe ImportFileJob, type: :job do
  let(:add_filename) { file_fixture('good_imports/add_competency_record.DAT').to_path }
  let(:update_filename) { file_fixture('good_imports/update_competency_record.DAT').to_path }
  let(:delete_filename) { file_fixture('good_imports/delete_competency_record.DAT').to_path }
  ...
  it 'creates a new CompetencyRecord' do
    ...
    # Expect values in the database to match input from add_competency_record.DAT.
  ...
  context 'with an existing CompetencyRecord' do
    ...
    it 'updates it' do
      ...
      # Expect values in the database to match input from update_competency_record.DAT.
