describe ImportFileJob, type: :job do
  let(:add_filename) { file_fixture('good_imports/add_position_eit_record.DAT').to_path }
  let(:update_filename) { file_fixture('good_imports/update_position_eit_record.DAT').to_path }
  let(:delete_filename) { file_fixture('good_imports/delete_position_eit_record.DAT').to_path }
  ...
  it 'creates a new PositionEitRecord' do
    ...
    # Expect values in the database to match input from add_position_eit_record.DAT.
  ...
  context 'with an existing PositionEitRecord' do
    ...
    it 'updates it' do
      ...
      # Expect values in the database to match input from update_position_eit_record.DAT.
