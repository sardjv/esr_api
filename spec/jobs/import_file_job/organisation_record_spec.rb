describe ImportFileJob, type: :job do
  ...
  let(:add_filename) { file_fixture('good_imports/add_organisation_record_20201015_00001157.DAT').to_path }
  let(:update_filename) { file_fixture('good_imports/update_organisation_record_20201015_00001157.DAT').to_path }
  let(:delete_filename) { file_fixture('good_imports/delete_organisation_record_20201015_00001157.DAT').to_path }
