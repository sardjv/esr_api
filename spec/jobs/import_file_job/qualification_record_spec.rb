describe ImportFileJob, type: :job do
  let(:add_filename) { file_fixture('good_imports/add_qualification_record.DAT').to_path }
  let(:update_filename) { file_fixture('good_imports/update_qualification_record.DAT').to_path }
  let(:delete_filename) { file_fixture('good_imports/delete_qualification_record.DAT').to_path }
  ...
  it 'creates a new QualificationRecord' do
    ...
    # Expect values in the database to match input from add_qualification_record.DAT.
  ...
  context 'with an existing QualificationRecord' do
    ...
    it 'updates it' do
      ...
      # Expect values in the database to match input from update_qualification_record.DAT.
