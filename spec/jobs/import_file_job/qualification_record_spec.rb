describe ImportFileJob, type: :job do
  ...
  let(:add_filename) do
    file_fixture('good_imports/add_qualification_record_20201015_00001157.DAT').to_path
  end
  let(:update_filename) do
    file_fixture('good_imports/update_qualification_record_20201015_00001157.DAT').to_path
  end
  let(:delete_filename) do
    file_fixture('good_imports/delete_qualification_record_20201015_00001157.DAT').to_path
  end
