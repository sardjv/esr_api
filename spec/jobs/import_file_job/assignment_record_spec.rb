describe ImportFileJob, type: :job do
  let(:add_filename) { file_fixture('good_imports/add_assignment_record.DAT').to_path }
  let(:update_filename) { file_fixture('good_imports/update_assignment_record.DAT').to_path }
  let(:delete_filename) { file_fixture('good_imports/delete_assignment_record.DAT').to_path }
  ...
  it 'creates a new AssignmentRecord' do
    ...
    # Expect values in the database to match input from add_assignment_record.DAT.
  ...
  context 'with an existing AssignmentRecord' do
    ...
    it 'updates it' do
      ...
      # Expect values in the database to match input from update_assignment_record.DAT.
