describe ImportFileJob, type: :job do
  let(:add_filename) { file_fixture('good_imports/add_person_record.DAT').to_path }
  let(:update_filename) { file_fixture('good_imports/update_person_record.DAT').to_path }
  let(:delete_filename) { file_fixture('good_imports/delete_person_record.DAT').to_path }
  ...
  it 'creates a new PersonRecord' do
    ...
    # Expect values in the database to match input from add_person_record.DAT.
  ...
  context 'with an existing PersonRecord' do
    ...
    it 'updates it' do
      ...
      # Expect values in the database to match input from update_person_record.DAT.
