...
class TrainingAbsenceRecordDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  ATTRIBUTE_TYPES = {
    ...
    :'Projected Start Date' => Field::Date,
    :'Projected Start Time' => Field::String,
    :'Projected End Date' => Field::Date,
    :'Projected End Time' => Field::String,
    :'Actual Start Date' => Field::Date,
    :'Actual Start Time' => Field::String,
    :'Actual End Date' => Field::Date,
    :'Actual End Time' => Field::String,
    :'Sickness Start Date' => Field::Date,
    :'Sickness End Date' => Field::Date,
    ...
    :'Return To Work Discussion Date' => Field::Date,
    :'Occupational Health Referral Date' => Field::Date,
