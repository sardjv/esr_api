...
class AssignmentRecordDashboard < Administrate::BaseDashboard
  ...
  ATTRIBUTE_TYPES = {
    ...
    :'Effective Start Date' => Field::Date,
    :'Effective End Date' => Field::Date,
    :'Earliest Assignment Start Date' => Field::Date,
    ...
    :'Start Date in Grade' => Field::Date,
