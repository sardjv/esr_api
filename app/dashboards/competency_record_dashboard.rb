...
class CompetencyRecordDashboard < Administrate::BaseDashboard
  ...
  ATTRIBUTE_TYPES = {
    ...
    'Certification Date': Field::Date.with_options(transform_on_export: lambda { |field|
                                                                          field.data&.strftime('%d/%m/%Y')
                                                                        }),
    'Certification Method': Field::String,
    'Next Certification Date': Field::Date.with_options(transform_on_export: lambda { |field|
                                                                               field.data&.strftime('%d/%m/%Y')
                                                                             }),
