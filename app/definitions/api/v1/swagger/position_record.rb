  ...
  def self.definitions
    {
      position_record_attributes: {
        ...
        properties: {
          ...
          'PositionID' => { type: 'string', example: '5204401', 'x-nullable': true },
          'Effective FromDate' => { type: 'date', example: '2019-04-22', 'x-nullable': true },
          'Effective ToDate' => { type: 'date', example: nil, 'x-nullable': true },
          'Position Number' => { type: 'string', example: '9235001', 'x-nullable': true },
          'Position Name' => { type: 'string', example: '9235001|Core Trainee|001|', 'x-nullable': true},
          'Budgeted FTE' => { type: 'string', example: '3.53', 'x-nullable': true},
          'Subjective Code' => { type: 'string', example: '2772101', 'x-nullable': true},
          'Job StaffGroup' => { type: 'string', example: 'Medical and Dental', 'x-nullable': true},
          ...
          'Workplace OrgCode' => { type: 'string', example: nil, 'x-nullable': true},
          'Last UpdateDate' => { type: 'date-time', example: '2019-10-03T12:17:01.000Z', 'x-nullable': true },
          'Subjective CodeDescription' => { type: 'string', example: 'RT Doctor', 'x-nullable': true},
