  ...
  def self.definitions
    {
      person_record_attributes: {
        ...
        properties: {
          ...
          'PersonID' => { type: 'string', example: '481801', 'x-nullable': true },
          'Effective StartDate' => { type: 'date', example: '20170501', 'x-nullable': true },
          'Effective EndDate' => { type: 'date', example: nil, 'x-nullable': true },
          'Employee Number' => { type: 'string', example: '10259801', 'x-nullable': true },
          ...
          'Date of Birth' => { type: 'date', example: '19860801', 'x-nullable': true },
          ...
          'HireDate' => { type: 'date', example: '20040601', 'x-nullable': true },
          'ActualTermination Date' => { type: 'date', example: nil, 'x-nullable': true },
          ...
          'WTR Opt Out Date' => { type: 'date', example: nil, 'x-nullable': true },
          ...
          'CSD 3 Months' => { type: 'date', example: '20030701', 'x-nullable': true },
          'CSD 12 Months' => { type: 'date', example: '20040401', 'x-nullable': true },
          ...
          'NHS StartDate' => { type: 'date', example: '20030701', 'x-nullable': true },
          'Last UpdateDate' => { type: 'date', example: '20170501', 'x-nullable': true },
