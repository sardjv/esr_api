class CreateTrainingAbsenceRecords < ActiveRecord::Migration[6.0]
  def change
    create_table :training_absence_records do |t|
      t.string 'Person ID'
    ...
    add_index :training_absence_records, ['Absence Attendance ID'], unique: true
  end
end
